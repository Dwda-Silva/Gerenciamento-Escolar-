...
def abrir_cadastro_alunos():
    ...
    tk.Button(cadastro_alunos_window, text="Excluir Aluno", command=excluir_aluno).grid(row=7, column=0, pady=10)
...
def excluir_aluno():
    selected_item = tabela_alunos.selection()[0]
    matricula = tabela_alunos.item(selected_item)['values'][0]
